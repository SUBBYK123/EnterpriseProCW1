...
public class SecurityConfig {
        ...
        // Dependency on Encryptor class for password hashing (not used directly in this
        // config)
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                .authorizeHttpRequests(authorize -> authorize
                                                // Publicly accessible endpoints (login, signup, static resources, reset
                                                // password)
                                                .requestMatchers("/login", "/", "/index", "/signup", "/css/**",
                                                                "/js/**", "/images/**", "/reset")
                                                .permitAll()
                                                .requestMatchers("/upload-dataset").authenticated()
                                ...
                                .formLogin(form -> form
                                                ...
                                                .defaultSuccessUrl("/index", true) // Redirect to index after successful
                                                                                   // login
                                                .usernameParameter("emailAddress") // Custom username field (email-based
                                                                                   // login)
