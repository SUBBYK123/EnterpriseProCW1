...
public class RegistrationRepositoryImpl implements RegistrationRepository {
    ...
    private static final String JDBC_PASSWORD = "Pakistan@1"; // Consider storing passwords securely (e.g., environment variables)
    ...
    /**
     * Extracts user details from a ResultSet and returns a RegistrationModel object.
     *
